...
mongoose.connect(
  "mongodb+srv://balsangram1:ohgk8HnIAPBRCH5m@cluster0.wplm9bx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
);
app.get("/", (req, res) => {
  res.send("hello");
});
...
//   } catch (error) {
//     res.status(500).send("Problem in registration form");
//     console.error(error);
//   }
// });
// app.post("/user/register", async (req, res) => {
